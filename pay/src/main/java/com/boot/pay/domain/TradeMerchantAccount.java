...
/**
 * 商户资金账户表
 * @TableName trade_merchant_account
 */
@TableName(value ="trade_merchant_account")
@Data
public class TradeMerchantAccount {
    /**
     * 账户ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        TradeMerchantAccount other = (TradeMerchantAccount) that;
