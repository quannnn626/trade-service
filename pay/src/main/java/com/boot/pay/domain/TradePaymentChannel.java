...
/**
 * 支付渠道表
 * @TableName trade_payment_channel
 */
@TableName(value ="trade_payment_channel")
@Data
public class TradePaymentChannel {
    /**
     * 渠道ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        TradePaymentChannel other = (TradePaymentChannel) that;
